...
export const createFile = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    // Check if the file with the same name already exixts in this parent folder
...
export const createFolder = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (project.ownerId !== identity.subject) {
      throw new Error("Unauthrorized to access this project");
    }
...
export const renameFile = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    const siblingExists = siblings.find(
      (sibling) =>
